...
class Msg extends Base
{
    ...
    {
        $ret = $this->send('msg/sendMsg.action', array_merge($options, [
            'from' => $from,
            'ope' => $ope,
            'to' => $to,
            'type' => $type,
    ...
    {
        $this->send('msg/sendBatchMsg.action', array_merge($options, [
            'fromAccid' => $fromAccid,
    ...
    {
        $this->send('msg/sendAttachMsg.action', array_merge($options, [
            'from' => $from,
            'msgtype' => $msgtype,
            'to' => $to,
            'attach' => $attach,
    ...
    {
        $this->send('msg/sendBatchAttachMsg.action', array_merge($options, [
            'fromAccid' => $fromAccid,
            'toAccids' => json_encode($toAccids),
            'attach' => $attach,
        ]));
